...
const performUserDocOp = async (model, id, username, opCallback) => {
  console.log(`performUserDocOp is running with id: ${id} user: ${username}`);
...
const findUserDoc = async (model, id, username) => {
  console.log(`findUserDoc is running with id: ${id} user: ${username}`);
...
const deleteUserDoc = async (model, id, username) => {
  console.log(`deleteUserDoc is running with id: ${id} user: ${username}`);
...
const userDocActionOr404 = async (model, id, user, res, action, msg) => {
  console.log(`userDocActionOr404 is running with id: ${id} user: ${user}`);
...
const fetchUserDocOr404 = async (model, id, user, res, msg) => {
  console.log(`fetchUserDocOr404 is running with id: ${id} user: ${user}`);
...
const deleteUserDocOr404 = async (model, id, user, res, msg) => {
  console.log(`deleteUserDocOr404 is running with id: ${id} user: ${user}`);
...
const listUserDocs = async (model, username, sort) => {
  console.log(`listUserDocs is running with user: ${username}`);
...
const createUniqueDoc = async (model, fields, uniqueQuery, res, duplicateMsg) => {
  console.log('createUniqueDoc is running');
...
const updateUserDoc = async (model, id, username, fieldsToUpdate, uniqueQuery, res, duplicateMsg) => {
  console.log(`updateUserDoc is running with id: ${id} user: ${username}`);

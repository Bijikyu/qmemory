...
function add(a, b) {
  ...
  return a + b; // Uses JS addition which handles floats and ints - now with validation
}
...
function isEven(num) {
  ...
  return num % 2 === 0; // Modulo check works for negatives and positives - now validated
}

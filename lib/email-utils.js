...
const { validateEmail } = require('./qgenutils-wrapper');
...
/**
 * Validates email format using qgenutils validation
 * 
 * Uses qgenutils.validateEmail for consistent email validation
 * across the application. Note: qgenutils.validateEmail returns

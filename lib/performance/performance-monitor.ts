...
class PerformanceMonitor {
  ...
  constructor(options: PerformanceMonitorOptions = {}) {
    ...
    this.database.on('slowQuery', (query: any) => {
   ...
   */
  createRequestMiddleware(): (req: any, res: any, next: any) => void {
   ...
   */
  wrapDatabaseOperation<T extends any[]>(operation: (...args: T) => Promise<any>, operationName: string): (...args: T) => Promise<any> {

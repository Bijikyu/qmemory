...
let ObjectStorageBinaryStorage = null; // Hold optional object storage implementation when available
let objectStorageImportError = null; // Track why the optional dependency failed to load for better diagnostics

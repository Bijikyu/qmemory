 ...
 */
function validatePagination(req: Request, res: Response, options: PaginationOptions = {}): PaginationParams | null { // standard query parameter validation for pagination
...
function validateCursorPagination(req: Request, res: Response, options: CursorPaginationOptions = {}): CursorPaginationParams | null { // cursor-based pagination validation
    ...
    try {
        ...
        const direction = (req.query.direction as string) || 'next'; // 'next' or 'prev'
        ...
        const pagination: CursorPaginationParams = { 
            ...
            sort,
            rawCursor: cursor as string | null
        };
 ...
 */
function createCursor(record: any, sortField: string = 'id'): string | null { // generate encoded cursor for pagination
 ...
 */
function validateSorting(req: Request, res: Response, options: SortingOptions = {}): SortingResult | null { // sorting parameter validation

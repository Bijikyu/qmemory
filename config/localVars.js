...
export const DEFAULT_CIRCUIT_BREAKER_ERROR_THRESHOLD = process.env.CIRCUIT_BREAKER_ERROR_THRESHOLD || 50;
export const DEFAULT_CIRCUIT_BREAKER_RESET_TIMEOUT = process.env.CIRCUIT_BREAKER_RESET_TIMEOUT || 60000;
export const DEFAULT_CIRCUIT_BREAKER_FAILURE_THRESHOLD = process.env.CIRCUIT_BREAKER_FAILURE_THRESHOLD || 5;
 ...
 */
export const DEFAULT_SYSTEM_COLLECTION_INTERVAL = process.env.DEFAULT_SYSTEM_COLLECTION_INTERVAL || 30000;
...
export const DEFAULT_POOL_HEALTH_CHECK_INTERVAL = process.env.DEFAULT_POOL_HEALTH_CHECK_INTERVAL || 60000;
...
export const DEFAULT_CURSOR_PAGINATION_MAX_LIMIT = process.env.DEFAULT_CURSOR_PAGINATION_MAX_LIMIT || 100;
...
export const DEFAULT_MEMORY_CRITICAL_THRESHOLD = process.env.DEFAULT_MEMORY_CRITICAL_THRESHOLD || 75;
...
export const DEFAULT_ERROR_RATE_WARNING_THRESHOLD = process.env.DEFAULT_ERROR_RATE_WARNING_THRESHOLD || 10;
export const DEFAULT_ERROR_RATE_CRITICAL_THRESHOLD = process.env.DEFAULT_ERROR_RATE_CRITICAL_THRESHOLD || 50;
...
//# sourceMappingURL=localVars.js.map
...
### Output:
```
  ● Utils module › add function › should throw error for non-numeric inputs

    expect(received).toThrow(expected)

    Expected substring: "Both parameters must be numbers for arithmetic operations"
    Received message:   "a must be a number"

          142 |     context?: Partial<ErrorContext>
          143 |   ): ValidationError {
        > 144 |     return new ValidationError(`${field} must be a ${expectedType}`, 'INVALID_TYPE', {
              |            ^
          145 |       field,
          146 |       expectedType,
          147 |       actualType,

      at Function.invalidType (lib/core/centralized-errors.ts:144:12)
      at Object.number (lib/core/centralized-errors.ts:344:26)
      at add (lib/utils.ts:17:10)
      at test/unit/utils.test.ts:66:23
      at Object.<anonymous> (node_modules/@jest/expect/node_modules/expect/build/toThrowMatchers.js:74:11)
      at Object.throwingMatcher [as toThrow] (node_modules/@jest/expect/node_modules/expect/build/index.js:320:21)
      at Object.<anonymous> (test/unit/utils.test.ts:66:40)
      at Object.<anonymous> (test/unit/utils.test.ts:66:40)

  ● Utils module › add function › should handle infinity

    ValidationError: a must be a number
    ...
    > 144 |     return new ValidationError(`${field} must be a ${expectedType}`, 'INVALID_TYPE', {
      ...
      at Object.number (lib/core/centralized-errors.ts:344:26)
      at add (lib/utils.ts:17:10)
      at Object.<anonymous> (test/unit/utils.test.ts:81:17)

  ● Utils module › isEven function › should throw error for non-integer inputs

    expect(received).toThrow(expected)

    Expected substring: "Parameter must be an integer for even/odd calculation"
    Received message:   "num must be a integer"
      ...
      at Function.invalidType (lib/core/centralized-errors.ts:144:12)
      at Object.integer (lib/core/centralized-errors.ts:350:26)
      at isEven (lib/utils.ts:26:10)
      at test/unit/utils.test.ts:115:26
      at Object.<anonymous> (node_modules/@jest/expect/node_modules/expect/build/toThrowMatchers.js:74:11)
      at Object.throwingMatcher [as toThrow] (node_modules/@jest/expect/node_modules/expect/build/index.js:320:21)
      at Object.<anonymous> (test/unit/utils.test.ts:115:40)
      at Object.<anonymous> (test/unit/utils.test.ts:115:40)
...
- Generated: 2026-01-06T02:14:37.191Z
